...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Favorite', fields ['reading', 'user']
        db.create_unique('favorites_favorite', ['reading_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Favorite', fields ['reading', 'user']
        db.delete_unique('favorites_favorite', ['reading_id', 'user_id'])
    ...
    models = {
        ...
        'favorites.favorite': {
            'Meta': {'unique_together': "(('reading', 'user'),)", 'object_name': 'Favorite'},
