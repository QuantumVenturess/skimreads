...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.tie'
        db.add_column('notifications_notification', 'tie',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tags.Tie'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Notification.vote'
        db.add_column('notifications_notification', 'vote',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['votes.Vote'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.tie'
        db.delete_column('notifications_notification', 'tie_id')

        # Deleting field 'Notification.vote'
        db.delete_column('notifications_notification', 'vote_id')
    ...
    models = {
        ...
        'notifications.notification': {
            ...
            'tie': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tags.Tie']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'viewed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'vote': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['votes.Vote']", 'null': 'True', 'blank': 'True'})
        },
        'readings.note': {
        ...
        'tags.tie': {
            'Meta': {'ordering': "['tag__name']", 'unique_together': "(('reading', 'tag'),)", 'object_name': 'Tie'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reading': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['readings.Reading']"}),
        ...
        'votes.vote': {
            'Meta': {'unique_together': "(('note', 'user'),)", 'object_name': 'Vote'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['readings.Note']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
