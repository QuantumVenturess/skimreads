...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.me'
        db.delete_column('notifications_notification', 'me_id')

        # Deleting field 'Notification.you'
        db.delete_column('notifications_notification', 'you_id')
    ...
    def backwards(self, orm):
        # Adding field 'Notification.me'
        db.add_column('notifications_notification', 'me',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='notification_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Notification.you'
        db.add_column('notifications_notification', 'you',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='notified_set', to=orm['auth.User']),
                      keep_default=False)
