...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Notification.follow' to match new field type.
        db.rename_column('notifications_notification', 'follow_id', 'follow')
        # Changing field 'Notification.follow'
        db.alter_column('notifications_notification', 'follow', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Removing index on 'Notification', fields ['follow']
        db.delete_index('notifications_notification', ['follow_id'])


    def backwards(self, orm):
        # Adding index on 'Notification', fields ['follow']
        db.create_index('notifications_notification', ['follow_id'])


        # Renaming column for 'Notification.follow' to match new field type.
        db.rename_column('notifications_notification', 'follow', 'follow_id')
        # Changing field 'Notification.follow'
        db.alter_column('notifications_notification', 'follow_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['follows.Follow'], null=True))
    ...
    models = {
        ...
        'notifications.notification': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'follow': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
