...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Tie'
        db.create_table('tags_tie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('reading', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['readings.Reading'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tags.Tag'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('tags', ['Tie'])

        # Adding unique constraint on 'Tie', fields ['reading', 'tag']
        db.create_unique('tags_tie', ['reading_id', 'tag_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Tie', fields ['reading', 'tag']
        db.delete_unique('tags_tie', ['reading_id', 'tag_id'])

        # Deleting model 'Tag'
        db.delete_table('tags_tag')

        # Deleting model 'Tie'
        db.delete_table('tags_tie')
    ...
    models = {
        ...
        'tags.tie': {
            'Meta': {'unique_together': "(('reading', 'tag'),)", 'object_name': 'Tie'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
