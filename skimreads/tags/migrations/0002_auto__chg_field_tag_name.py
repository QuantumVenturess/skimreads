...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tags_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Tag.name'
        db.alter_column('tags_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
