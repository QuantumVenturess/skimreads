...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('readings_note', 'content', self.gf('django.db.models.fields.CharField')(max_length=120))

    def backwards(self, orm):

        # Changing field 'Note.content'
        db.alter_column('readings_note', 'content', self.gf('django.db.models.fields.TextField')(max_length=100))
