...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reading.title'
        db.alter_column('readings_reading', 'title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80))

    def backwards(self, orm):

        # Changing field 'Reading.title'
        db.alter_column('readings_reading', 'title', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))
    ...
    models = {
        ...
        'readings.note': {
            ...
            'deny': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
