...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Note.deny'
        db.delete_column('readings_note', 'deny')

        # Deleting field 'Note.approve'
        db.delete_column('readings_note', 'approve')


    def backwards(self, orm):
        # Adding field 'Note.deny'
        db.add_column('readings_note', 'deny',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Note.approve'
        db.add_column('readings_note', 'approve',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
