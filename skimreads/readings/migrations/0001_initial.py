...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('readings_reading', (
        ...
        db.send_create_signal('readings', ['Reading'])

        # Adding model 'Note'
        db.create_table('readings_note', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('readings', ['Note'])


    def backwards(self, orm):
        # Deleting model 'Reading'
        db.delete_table('readings_reading')

        # Deleting model 'Note'
        db.delete_table('readings_note')
