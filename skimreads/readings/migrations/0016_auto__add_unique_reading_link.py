...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Reading', fields ['link']
        db.create_unique('readings_reading', ['link'])


    def backwards(self, orm):
        # Removing unique constraint on 'Reading', fields ['link']
        db.delete_unique('readings_reading', ['link'])
