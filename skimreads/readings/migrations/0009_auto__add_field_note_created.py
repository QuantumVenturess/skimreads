...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('readings_note', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 20, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Note.created'
        db.delete_column('readings_note', 'created')
