...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reading.slug'
        db.alter_column('readings_reading', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Reading.slug'
        db.alter_column('readings_reading', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
