...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reading.link'
        db.alter_column('readings_reading', 'link', self.gf('django.db.models.fields.TextField')(unique=True))

    def backwards(self, orm):

        # Changing field 'Reading.link'
        db.alter_column('readings_reading', 'link', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
