...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Vote', fields ['note', 'user']
        db.create_unique('votes_vote', ['note_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['note', 'user']
        db.delete_unique('votes_vote', ['note_id', 'user_id'])
