...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notifications_notification', (
            ...
            ('follow', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['follows.Follow'], null=True, blank=True)),
            ('note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['readings.Note'], null=True, blank=True)),
            ('reply', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replies.Reply'], null=True, blank=True)),
            ('viewed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('me', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notification_set', to=orm['auth.User'])),
            ('you', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notified_set', to=orm['auth.User'])),
        ))
    ...
    models = {
        ...
        'notifications.notification': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'me': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notification_set'", 'to': "orm['auth.User']"}),
            ...
            'you': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notified_set'", 'to': "orm['auth.User']"})
        },
        'readings.note': {
