...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('usermessages_usermessage', (
        ...
        db.send_create_signal('usermessages', ['UserMessage'])


    def backwards(self, orm):
        # Deleting model 'UserMessage'
        db.delete_table('usermessages_usermessage')
    ...
    models = {
        ...
        'usermessages.usermessage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'received_messages'", 'to': "orm['auth.User']"}),
